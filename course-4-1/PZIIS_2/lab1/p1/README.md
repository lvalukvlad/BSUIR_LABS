...
Проверки каталогов: list / create зонда / удаление каждого существующего `file*` с восстановлением. Исполнение файлов — реальный запуск (shebang + чтение), не только `test -x`.
