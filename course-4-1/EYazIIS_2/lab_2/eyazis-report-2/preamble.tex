...
% Подписи таблиц, рисунков и листингов: курсив, по центру, под объектом.
\DeclareCaptionLabelFormat{stbfigure}{Рисунок #2}
\DeclareCaptionLabelFormat{stbtable}{Таблица #2}
\DeclareCaptionLabelFormat{stblisting}{Листинг #2}
\DeclareCaptionLabelSeparator{stb}{~--~}
\captionsetup{labelsep=stb}
\captionsetup[figure]{labelformat=stbfigure, justification=centering, font={small,it}}
\captionsetup[lstlisting]{labelformat=stblisting, justification=centering, font={small,it}}
\captionsetup[table]{labelformat=stbtable, justification=centering, font={small,it}}
...
\newcommand{\mdash}{\nobreak\,\raisebox{0.12ex}{\rule{0.9em}{0.55pt}}\,}
