"""Модели данных для словаря — ОБНОВЛЁННАЯ ВЕРСИЯ"""
...
@dataclass
class MorphRule:
    """Правило образования словоформы"""
    ending: str
    grammemes: Dict[str, str]  # {"падеж": "родительный", "род": "мужской", "число": "единственное"}
...
@dataclass
class LemmaEntry:
    """Запись словаря: лемма + правила словоизменения"""
    lemma: str
    stem: str
    pos: str
